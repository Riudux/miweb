...
<body>
    ...
    <section>
        <h1 class="text-center">Detalle de Oxígeno en Sangre</h1>
        ...
        <div id="chart-oxigeno-detallado" style="background: white; border-radius: 8px; padding: 15px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); margin-bottom: 30px;"></div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(function(registro) {
                        ...
                        let valor = parseFloat(registro.oxigeno);
                    ...
                    var opciones = {
                        ...
                        title: {
                            text: 'Evolución del Nivel de Oxígeno',
                            align: 'left'
                        },
                        grid: {
                            row: {
                        ...
                        colors: ['#00E396'] // Verde azulado para oxígeno
                    };
                    ...
                    chart = new ApexCharts(document.querySelector("#chart-oxigeno-detallado"), opciones);
                    chart.render();
                }
            });
        }
