...
<head>
    ...
    <title>Ritmo Cardíaco Detallado</title>
...
<body>
    ...
    <section>
        <h1 class="text-center">Detalle de Ritmo Cardíaco</h1>
        ...
        <div id="chart-ritmo-detallado" style="background: white; border-radius: 8px; padding: 15px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); margin-bottom: 30px;"></div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(function(registro) {
                        ...
                        let valorLPM = parseFloat(registro.ritmo_cardiaco);

                        fechas.push(fechaSola);
                        valores.push(valorLPM);
                    ...
                    var opciones = {
                        ...
                        stroke: {
                            curve: 'straight' // Línea recta uniendo los puntos
                        },
                        title: {
                            text: 'Evolución de Latidos por Minuto',
                            align: 'left'
                        },
                        grid: {
                            row: {
                        ...
                        colors: ['#FF4560'] // Rojo para el corazón
                    };
                    ...
                    chart = new ApexCharts(document.querySelector("#chart-ritmo-detallado"), opciones);
                    chart.render();
                }
            });
        }
